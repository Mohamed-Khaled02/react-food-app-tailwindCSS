...
function HeadlineCard() {
  return (
    <div className=' py-12 gap-6 grid md:grid-cols-3'>
      {/* card */}
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-white bg-white text-black mx-2 px-5 rounded-full py-1 absolute bottom-4'>Order Now</button>
        </div>
        <img
